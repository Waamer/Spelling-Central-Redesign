...
⚠️ Notes
For best performance, open the project using a modern browser (Chrome, Edge, Safari).
If navigation issues occur, ensure all project files remain in their original folder structure.